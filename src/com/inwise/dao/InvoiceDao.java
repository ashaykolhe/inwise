...
import com.inwise.pojo.InvoiceDetail;
   ...
   Integer ii=(Integer)sessionProvider.get().createSQLQuery("select id from product where product_name='"+name+"'").uniqueResult();
    ...
    public String createPdf(Invoice invoice, Advance advance) {
        ...
        Document document=new Document(PageSize.A4, -70, -70, 10, 10);
             filepath="c:/Inwise/"+invoice.getCustomer().getName()+"_"+invoice.getOrder().getCustomerOrderNo()+".pdf";
            ...
            firstrowtable2.addCell(issuecellvalue);
                    ...
                    secrowmntable.addCell(tablecon);
                        ...
                        PdfPCell cellconval = new PdfPCell(new Phrase(invoice.getCustomer().getName()+ Chunk.NEWLINE  , FontFactory.getFont(FontFactory.TIMES_ROMAN, 9)));
                        cellconval.setHorizontalAlignment(Element.ALIGN_LEFT);
                        cellconval.setBorder(Rectangle.NO_BORDER);
                        tablecon.addCell(cellconval );
                        secrowmntable.addCell(tablecon);
            ...
            PdfPCell datecell3value = new PdfPCell(new Phrase(desdate, FontFactory.getFont(FontFactory.TIMES_ROMAN, 9)));
                    ...
                    String icid = invoice.getCustomer().getCustomerCode();
                    //String scid =  new Integer(icid).toString();
		  
                    PdfPCell cuscellval = new PdfPCell(new Phrase(icid, FontFactory.getFont(FontFactory.TIMES_ROMAN, 8)));
            ...
            String contractdate;
			  ...
			  else
			  {
                   ...
                   PdfPTable ecesstable= new PdfPTable(1);
                    ...
                    PdfPCell excisecellval = new PdfPCell(new Phrase(Convert(invoice.getExcise()), FontFactory.getFont(FontFactory.TIMES_ROMAN, 9)));
                    ...
                    PdfPCell ecesscellval = new PdfPCell(new Phrase(Convert(invoice.getEducationCess()), FontFactory.getFont(FontFactory.TIMES_ROMAN, 9)));
                    ...
                    PdfPCell sheducellval = new PdfPCell(new Phrase(Convert(invoice.getSecondaryHigherEducationCess()), FontFactory.getFont(FontFactory.TIMES_ROMAN, 9)));
