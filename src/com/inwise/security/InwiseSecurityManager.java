...
import com.inwise.action.UserActionBean;
...
public class InwiseSecurityManager extends InstanceBasedSecurityManager implements SecurityHandler{
    @Override
...
//        return false;
    ...
    public Resolution handleAccessDenied(ActionBean actionBean, Method method) {
        if(!(isUserAuthenticated(actionBean,method))){
            RedirectResolution resolution=new RedirectResolution(UserActionBean.class);
