            ...
            <td height="20" colspan="2"> <s:layout-component name="menu">
                <div class="menu">
                    ...
                    <ul>
                      ...
                      <li><s:link beanclass="com.inwise.action.TaxActionBean" event="addTaxLink">Tax</s:link></li>
                        ...
                        <li><a class="hide" href="#">Invoice</a>
                                               <ul>
                                                     ...
                                                     <li><s:link beanclass="com.inwise.action.InvoiceActionBean" event="editinvoice">Update</s:link></li>
