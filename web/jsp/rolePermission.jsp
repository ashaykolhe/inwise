...
<s:useActionBean beanclass="com.inwise.action.UserActionBean" var="userBean" event="rolePermissionLink"></s:useActionBean>
<% request.setAttribute("rolelst",userBean.getRolelst());
%>
  ...
  <tr>
   ...
   <div align="right" style="margin-left: 2px;" class="labels">Select Role<span style="color:#FF0000"> *</span></div></td>
		  <td width="78%" align="left" valign="top" >
              <s:form beanclass="com.inwise.action.UserActionBean" id="getRolePermissions" name="getRolePermissions" method="get">
