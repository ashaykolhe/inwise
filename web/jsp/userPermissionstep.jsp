<%@ page import="com.inwise.enums.EnumModule" %>
<%--
...
<s:useActionBean beanclass="com.inwise.action.UserActionBean" var="listofuser" event="userPermissionLink"></s:useActionBean>
...
<tr><td><div class="wizard-steps">
  <div class="completed-step"><s:link beanclass="com.inwise.action.UserActionBean" event="userLink"><span>1</span> Add User</a></s:link></div>
  <div class="completed-step"><s:link beanclass="com.inwise.action.UserActionBean" event="roleLink"><span>2</span> Set Role Permission</a></s:link></div>
...
<s:form beanclass="com.inwise.action.UserActionBean" id="getUserPermissions" name="getUserPermissions" method="get">
